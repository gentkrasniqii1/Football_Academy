...
<body>
  ...
  <div class="container-one">
    ...
    <div class="section">
      ...
      <div class="highlights">
        <div class="highlight-card">
          <img src="suportersthree.webp" alt="Highlight">
          <span>Macedonia</span>
        </div>
        <div class="highlight-card">
          <img src="suportersfour.webp" alt="Highlight">
          <span>Munich</span>
        </div>
        <div class="highlight-card">
          <img src="suportersfive.jpeg" alt="Highlight">
          <span>Sur de California</span>
        </div>
        <div class="highlight-card">
          <img src="suporterssix.jpeg" alt="Highlight">
          <span>Atlanta</span>
        </div>
        <div class="highlight-card">
          <img src="suportersseven.jpeg" alt="Highlight">
          <span>Boston</span>
        </div>
        <div class="highlight-card">
          <img src="suporterseight.jpeg" alt="Highlight">
    ...
    <div class="news-section">
      <div class="main-news">
        <img src="suporters.webp" alt="Main News">
      ...
      <div class="secondary-news">
        <div class="news-item">
          <img src="suporterstwo.webp" alt="News 1">
          <h4>Emotional tribute to Goyo Benito</h4>
        </div>

        <div class="news-item">
          <img src="suporterstwo.webp" alt="News 2">
          <h4>Madridista Supporter Club inaugurated in Beit Sahour</h4>
        </div>
        ...
        <div class="news-item">
          <img src="suporterstwo.webp" alt="News 3">
          <h4>Florentino Pérez hosted the madridistas fan group event in Jeddah</h4>
        </div>
      </div>
    </div>
  </div>
